...
export const Footer = () => {
  return (
    <footer className="bg-black px-4 2xl:flex 2xl:justify-center">
      <div style={{ width: "100%" }} className="w-full border border-red-500">
        <h4 className="text-white text-5xl font-bold">Let’s talk.</h4>
        <a
